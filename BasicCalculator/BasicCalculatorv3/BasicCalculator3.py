...
root = Tk()
root.title("SimplestCalculator .v3(FullyWorking)")
...
button_c = Button(root, text="C", padx=40, pady=20, command=button_c)
button_clear = Button(root, text="CE", padx=30, pady=20, command=button_clear)
